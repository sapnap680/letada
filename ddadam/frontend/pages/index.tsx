        ...
        <div className="bg-white rounded-lg shadow-xl p-8">
          ...
          <div className="mb-8 flex flex-wrap gap-4">
            ...
            <button
              ...
              className="px-4 py-2 text-gray-600 hover:bg-purple-100 hover:text-purple-700 rounded-lg transition-colors"
            >
              🏀 大会IDモード
            </button>
            <button
              onClick={() => router.push("/csv")}
              className="px-4 py-2 text-gray-600 hover:bg-green-100 hover:text-green-700 rounded-lg transition-colors"
            >
              📊 CSVアップロード
            </button>
          </div>
