        ...
        <div className="bg-white rounded-lg shadow-xl p-8">
          ...
          <div className="mb-6">
            <label className="flex items-center space-x-3 cursor-pointer">
              ...
              />
              <span className="text-gray-700">PDFも生成する</span>
            </label>
            <p className="text-sm text-gray-500 mt-2 ml-8">
              Excel（照合結果）に加えてPDFも生成します
            </p>
          </div>
          ...
          <div className="mt-8 p-4 bg-purple-50 rounded-lg">
            <h3 className="font-semibold text-purple-900 mb-2">💡 大会IDモードとは？</h3>
            <ul className="list-disc list-inside text-sm text-purple-800 space-y-1">
              <li>大会ID1つで全大学のCSVを自動取得</li>
              <li>手動でCSVをダウンロードする必要なし</li>
              <li>全大学のデータを一括でJBA照合</li>
              <li>照合結果をExcelとPDFで出力</li>
            </ul>
          </div>
